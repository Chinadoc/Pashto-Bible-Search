...
import { getVerbInfo, getPassiveRootsAndStems, getAbilityRootsAndStems } from "./src/verb-info";
...
import { isPastTense, isInvalidSubjObjCombo } from "./src/phrase-building/vp-tools";
import { getInflectionPattern } from "./src/inflection-pattern";
import { makePsString, removeFVarients } from "./src/accent-and-ps-utils";
import { addToForm, concatPsString, isVerbBlock, isImperativeBlock, isPluralInflectionSet, isUnisexSet, isInflectionSet, addEnglish, endsWith, hasBaParticle, psRemove, firstVariation, psStringFromEntry, getLong, capitalizeFirstLetter, getLength, psStringEquals } from "./src/p-text-helpers";
import { joiningTails } from "./src/misc-text";
import { getEnglishWord } from "./src/get-english-word";
import { standardizePashto, standardizePhonetics } from "./src/standardize-pashto";
...
import { getEnglishFromRendered, getPashtoFromRendered } from "./src/phrase-building/np-tools";
import { convertSpelling, revertSpelling } from "./src/convert-spelling";
import { dictionaryEntryBooleanFields, dictionaryEntryNumberFields, dictionaryEntryTextFields } from "../types";
import { validateEntry, standardizeEntry } from "./src/validate-entry";
import { pashtoConsonants } from "./src/pashto-consonants";
import { isNounAdjOrVerb, getEnglishPersonInfo, getPersonFromVerbForm, getPersonNumber, personFromVerbBlockPos, getVerbBlockPosFromPerson, personIsPlural, personGender, parseEc, personNumber, randFromArray, chooseLength, isFirstPerson, isSecondPerson, isThirdPerson, blank, kidsBlank, ensureNonComboVerbInfo, entryOfFull } from "./src/misc-helpers";
...
import { removeAccents, hasAccents, splitUpSyllables, countSyllables } from "./src/accent-helpers";
import { makeNounSelection, makeAdjectiveSelection, makeAdverbSelection, makeLocativeAdverbSelection, makeParticipleSelection } from "./src/phrase-building/make-selections";
...
import { compileEP, compileVP, flattenLengths, combineIntoText } from "./src/phrase-building/compile";
...
import { humanReadableVerbForm, humanReadableEquativeTense } from "./src/human-readable";
