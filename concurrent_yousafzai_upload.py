#!/usr/bin/env python3
"""
Concurrent Yousafzai audio uploader with multiple parallel processes.
"""
...
def main():
    ...
    print("🚀 Starting concurrent Yousafzai audio uploader...")
    ...
    # Get files to upload
    files_to_upload, audio_data = get_files_to_upload()
    ...
    print(f"📦 Processing {len(files_to_upload)} files with {num_workers} workers...")
