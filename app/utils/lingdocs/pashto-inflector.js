...
function handlePluralNounOrAdj(w) {
    if (!w.c || !w.c.includes("n."))
        return false;
    const plurals = makePlural(w);
    if (w.noInf) {
...
// TODO: REMOVE THIS
export function inflectRegularYayUnisex(p, f) {
...
// TODO: REMOVE THIS
export function inflectRegularShwaEndingUnisex(pr, fr) {
