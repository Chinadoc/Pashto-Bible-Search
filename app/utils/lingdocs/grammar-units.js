...
export const aayTail = [
    { p: "ای", f: "aay" },
    { p: "ی", f: "ay" },
];
export const subjPastEquative = aayTail.map((a) => ({
    p: "و" + a.p,
    f: "w" + a.f,
}));
...
export const imperativeEndings = [
    // masc 2nd pers
    [
        [{ p: "ه", f: "a" }], // singular
        [{ p: "ئ", f: "ey" }], // plural
...
export const ooPrefix = { p: "و", f: "oo" };
export const baParticle = { p: "به", f: "ba" };
export const presentParticipleSuffix = { p: "ونکی", f: "oonkay" };
...
const ksPerf = kawulStat.info.root.perfective;
